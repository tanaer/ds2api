...
if ! node --test --test-concurrency=1 tests/node/stream-tool-sieve.test.js tests/node/chat-stream.test.js tests/node/js_compat_test.js tests/node/update-script.test.js tests/node/deploy-script.test.js "$@" 2>&1 | tee "$NODE_TEST_LOG"; then
  echo
